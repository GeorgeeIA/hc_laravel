            ...
            <div class="sidebar-heading">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('pasien.index') }}">
                                <i style="color: #F78B4E;" class="fas fa-fw fas fa-head-side-cough"></i>
                                <span style="color: #F78B4E;">Data Pasien</span></a>
                        </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 style="color: #F78B4E !important" class="m-0 font-weight-bold text-primary">Identitas Pasien</h6>
                        </div>
                        <div class="card-body">
                            <form  action="{{ route('pasien.update',['pasien' => $pasien->id]) }}" method="POST" enctype="multipart/form-data" style="color: black;">
                            @method('PATCH')
                            @csrf
                                <div class="form-group mb-3">
                                    <label for="nama">Nama Pasien</label>
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="nama" name="nama" value="{{ old('nama') ?? $pasien->name }}">
                                    @error('nama')
                                ...
                                <div class="form-group">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="jeniskelamin" id="jeniskelamin" class="form-control">
                                            <option value=""{{ (old('jeniskelamin') ?? $pasien->jeniskelamin)==
                                            'pilih' ? 'selected': '' }} > pilih</option>
                                            <option value="Laki-laki"{{ (old('jeniskelamin') ?? $pasien->jeniskelamin)==
                                            'Laki-laki' ? 'selected': '' }} > Laki-laki</option> 
                                            <option value="Perempuan"{{ (old('jeniskelamin') ?? $pasien->jeniskelamin)==
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    id="nohp" name="nohp" value="{{ old('nohp') ?? $pasien->nohp}}">
                                    @error('nohp')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <br><img height="150px" src="{{url('')}} / {{$pasien->image}}" class="rounded" alt="">
                                ...
                                <button style="color: #ffffff; background-color: #F78B4E;" type="submit" class="btn">Update</button>
                                <a href="{{ route('pasien.index') }}" class="btn btn-primary">Kembali</a></br>
                              </form>
                        </div>
                    </div>
