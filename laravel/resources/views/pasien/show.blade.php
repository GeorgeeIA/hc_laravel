            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Pasien {{$pasien->name}}</h1>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <ul style="color: black;">
                                    <li>Nama Pasien: {{$pasien->name}}</li>
                                    <li>Nik: {{$pasien->nik}}</li>
                                    <li>Jenis Kelamin: {{$pasien->jeniskelamin}}</li>
                                    <li>Alamat: {{$pasien->alamat}}</li>
                                    <li>NoHp: {{$pasien->nohp}}</li>
                                    <li>KTP : {{$pasien->image}}</li>
                                </ul>
                                <form action="{{ route('pasien.destroy',['pasien'=>$pasien->id]) }}" class="justify-contecnt-center" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button class="btn btn-danger py-1 mb-1" ><i class="	fas fa-trash-alt"> Hapus</i></button>
                                </form>
                                <a href="{{ route('pasien.index') }}" class="btn btn-primary py-1">kembali</a>
                            </div>
