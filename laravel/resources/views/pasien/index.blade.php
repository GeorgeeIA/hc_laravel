                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 style="color: #F78B4E !important" class="m-0 font-weight-bold text-primary">Table Data Pasien</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0" style="color: black;">
                                    ...
                                    @forelse ($pasien as $pasien)
                                        <tr style="font-size: small;">
                                            ...
                                            <td>{{$pasien->nohp}}</td>
                                            <td><img height="30px" src="{{url('')}}/{{$pasien->image}}" class="rounded" alt=""></td>
                                            <td>
                                                <a href="{{ route('pasien.edit',['pasien' => $pasien->id]) }}"><button style="padding: 5pt; background-color: #F78B4E; color: white;" class="btn py-0"><i class=" fas fa-edit">Edit</i></button></a>
                                                <a href="{{ route('pasien.show',['pasien' => $pasien->id]) }}"><button style="padding: 5pt;" class="btn btn-primary py-0"><i class="	fas far fa-clipboard">Cetak</i></button></a>
                                            </td>
                                        </tr>
                                        @empty
