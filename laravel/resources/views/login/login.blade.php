...
<html lang="en">
  <head>
    ...
    <title>Login Health Calls</title>
  ...
  <div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5 ">
      <div class="col-md-10 mx-auto col-lg-5">
        <form action="{{ route('login.process') }}" method="POST" class="p-4 p-md-5 border rounded-3 bg-light">
        @csrf
          <h3 class="py-2 text-center">Login</h3>
          ...
          <hr class="my-4">
          <small class="text-muted me-5">Belum Punya Akun ? <a href="{{ route('login.register') }}" class="btn-link">Daftar</a></small>
          <small class="text-muted"><a href="{{ route('landing.index') }}" class="btn-link">Kembali</a></small>
        </form>
      </div>
    </div>
  </div>
