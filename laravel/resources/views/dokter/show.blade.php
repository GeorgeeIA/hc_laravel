            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Dokter {{$dokter->name}}</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <ul style="color: black;">
                                <li>ID Dokter: {{$dokter->id}}</li>
                                <li>Nama Dokter: {{$dokter->name}}</li>
                                <li>Jenis Kelamin: {{$dokter->jeniskelamin}}</li>
                                <li>Alamat: {{$dokter->alamat}}</li>
                                <li>NoHp: {{$dokter->nohp}}</li>
                                <li>Poli: {{$dokter->poli}}</li>
                            </ul>
                            <form action="{{ route('dokter.destroy',['dokter'=>$dokter->id]) }}" method="POST">
                                @method('DELETE')
                                @csrf
