            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('obat.store') }}" method="POST" style="color: black;">
                            @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="type" id="" class="form-control">
                                        ...
                                        {{ old('type')=='Pilih' ? 'selected': '' }} >
                                        Pilih
                                        <option value="Kapsul">Kapsul</option>
                                        {{ old('type')=='Kapsul' ? 'selected': '' }} >
                                        Kapsul
                                        <option value="Kapsul">Tablet</option>
                                        {{ old('type')=='Kapsul' ? 'selected': '' }} >
                                        Kapsul
                                        <option value="Botol">Botol</option>
                                        {{ old('type')=='Botol' ? 'selected': '' }} >
                                        Botol
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    id="kadaluarsa" name="kadaluarsa" value="{{ old('kadaluarsa') }}">
                                    @error('kadaluarsa')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
