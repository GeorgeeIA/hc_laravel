                                ...
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0" style="color: black;">
                                    ...
                                    @forelse ($obat as $obat)
                                        <tr style="font-size: small;">
                                            ...
                                            <td>
                                            <a href="{{ route('obat.edit',['obat' => $obat->id]) }}"><button style="padding: 5pt; background-color: #F78B4E; color: white;" class="btn py-0"><i class=" fas fa-edit">Edit</i></button></a>
                                            <a href="{{ route('obat.show',['obat' => $obat->id]) }}"><button style="padding: 5pt;" class="btn btn-primary py-0"><i class="	fas far fa-clipboard">Cetak</i></button></a>
                                            </td>
                                        </tr>  
                                        @empty
