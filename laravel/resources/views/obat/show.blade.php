            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Obat {{$obat->name}}</h1>
                    </div>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 style="color: #F78B4E !important" class="m-0 font-weight-bold text-primary">Table Data Obat</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                            <ul style="color: black;">
                                    <li>Nama Obat: {{$obat->name}}</li>
                                    <li>Stok Obat: {{$obat->stok}}</li>
                                    <li>Type: {{$obat->type}}</li>
                                    <li>Harga: {{$obat->harga}}</li>
                                    <li>Tanggal Kadaluarsa: {{$obat->kadaluarsa}}</li>
                            </ul>
                                <form action="{{ route('obat.destroy',['obat'=>$obat->id]) }}" class="justify-contecnt-center" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button class="btn btn-danger py-1 mb-1" ><i class="	fas fa-trash-alt"> Hapus</i></button>
                                </form>
                                <a href="{{ route('obat.index') }}" class="btn btn-primary py-1">kembali</a>
                            </div>
