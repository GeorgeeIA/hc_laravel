                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 style="color: #F78B4E !important" class="m-0 font-weight-bold text-primary">Identitas Pegawai</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('pegawai.update',['pegawai' => $pegawai->id]) }}" method="POST" style="color: black;">
                            @method('PATCH')
                            @csrf
                                <div class="form-group mb-3">
                                    <label for="nama">Nama Pegawai</label>
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="nama" name="nama" value="{{ old('nama') ?? $pegawai->name}}">
                                    @error('nama')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    id="nohp" name="nohp" value="{{ old('nohp') ?? $pegawai->nohp}}">
                                    @error('nohp')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    id="level" name="level" value="{{ old('level') ?? $pegawai->level}}">
                                    @error('level')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <button style="color: #ffffff; background-color: #F78B4E;" type="submit" class="btn">Upload</button>
                                <a href="{{ route('pegawai.index') }}" class="btn btn-primary">Kembali</a></br>
                              </form>
                        </div>
                    </div>
