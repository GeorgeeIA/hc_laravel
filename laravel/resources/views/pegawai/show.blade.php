            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Pegawai {{$pegawai->name}}</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <ul style="color: black;">
                                    <li>Nama Pegawai: {{$pegawai->name}}</li>
                                    <li>Alamat: {{$pegawai->alamat == '' ? 'N/A' : $pegawai->alamat}}</li>
                                    <li>NoHp: {{$pegawai->nohp}}</li>
                                    <li>Level: {{$pegawai->level}}</li>
                                </ul>
                                <form action="{{ route('pegawai.destroy',['pegawai'=>$pegawai->id]) }}" class="justify-contecnt-center" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button class="btn btn-danger py-1 mb-1" ><i class="	fas fa-trash-alt"> Hapus</i></button>
                                </form>
                                <a href="{{ route('pegawai.index') }}" class="btn btn-primary py-1">kembali</a>
                            </div>
                        </div>
                    </div>
