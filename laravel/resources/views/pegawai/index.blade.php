        ...
        <ul style="background-color: rgba(0, 0, 0, 0.785);" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('pegawai.index') }}">
                    <i style="color: #F78B4E;" class="fas fa-fw fas fa-user-nurse"></i>
                    <span style="color: #F78B4E;">Data Pegawai</span></a>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 style="color: #F78B4E !important" class="m-0 font-weight-bold text-primary">Table Data Pegawai</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0" style="color: black;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="font-size: small;">
                                            ...
                                            <td>{{$pegawai->name}}</td>
                                            <td>{{$pegawai->alamat == '' ? 'N/A' : $pegawai->alamat}}</td>
                                            <td>{{$pegawai->nohp}}</td>
                                            <td>{{$pegawai->level}}</td>
                                            <td>
                                            <a href="{{ route('pegawai.edit',['pegawai' => $pegawai->id]) }}"><button style="padding: 5pt; background-color: #F78B4E; color: white;" class="btn py-0"><i class=" fas fa-edit">Edit</i></button></a>
                                            <a href="{{ route('pegawai.show',['pegawai' => $pegawai->id]) }}"><button style="padding: 5pt;" class="btn btn-primary py-0"><i class="	fas far fa-clipboard">Cetak</i></button></a>
                                            </td>
                                        </tr>
                                        @empty
